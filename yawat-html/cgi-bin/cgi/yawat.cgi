...
sub print_login_screen()
{
  ...
  my $lien = $q->url(); 
  $lien =~ s/http(.*)/https$1/; 
  print "<form method=POST action='",$lien,"'>\n";
...
sub print_task
{
  ...
  print "<html>\n";
  print "<head>\n";
  print include_css("../../css_js/yawat.css","../../css_js/tagset.css");
  print "<title>Yawat - Yet Another Word Alignment Tool</title>\n";
  print "</head>\n";
  print "<body>\n";
  includeScripts("../../css_js/yawat.js", "../../css_js/yawat-tagset.js", "../../css_js/yawat-ctm.js", "../../css_js/yawat-ctm1.js",
		 "../../css_js/yawat-word.js", "../../css_js/yawat-sentence.js", "../../css_js/yawat-agroup.js",
		 "../../css_js/yawat-matrix.js", "../../css_js/yawat-pane.js", "../../css_js/yawat-application.js",
		 "../../css_js/yawat-button.js");
  ...
  my $help = $q->url(); 
  $help =~ s/http(.*)/https$1/; 
  print "url_index = '",$help,($sdir ? "?subdir=$sdir" : ""), "';\n";
  if ($prevFile)
  {
